...
import CatBody from './components/CatBody.vue'
import CountPrice from './components/CountPrice.vue'

export default {
  name: 'App',
  components: { CatHeader, CatBody, CountPrice },
  mounted() {
...
<template>
  <div>
    ...
    <main>
      ...
      <button class="rounded-lg  border-gray-200 dark:bg-gray-900 dark:border-gray-700 text-white p-4 mt-5 mb-5 ml-4">清空購物車</button>
    </main>
