<template>
  ...
  <header>
        <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
          ...
          <input @input="searchCat" v-model="searchInput" type="search" id="default-search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="請輸入想尋找的貓貓" required>
...
export default {
  ...
  methods:{
    searchCat(){
      this.$store.commit('SEARCAT',this.searchInput)
    }
  }
}
</script>
